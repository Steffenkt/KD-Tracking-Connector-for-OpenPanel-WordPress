 ...
 * Text Domain:       kd-tracking-connector-openpanel
 */

if ( ! defined( 'ABSPATH' ) ) exit;

define( 'OPSH_VERSION',    '1.0.2' );
...
function opsh_admin_menu() {
    add_options_page(
        __( 'OpenPanel Analytics', 'kd-tracking-connector-openpanel' ),
        __( 'OpenPanel', 'kd-tracking-connector-openpanel' ),
        'manage_options',
...
function opsh_admin_init() {
    ...
    add_settings_section(
        ...
        __( 'Allgemein', 'kd-tracking-connector-openpanel' ),
        '__return_false',
        'kd-tracking-connector-openpanel'
    );
    ...
    add_settings_field(
        'opsh_enabled',
        __( 'OpenPanel aktivieren', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_general',
    ...
    add_settings_field(
        'opsh_client_id',
        __( 'Client ID', 'kd-tracking-connector-openpanel' ),
        'opsh_field_text',
        'kd-tracking-connector-openpanel',
        'opsh_section_general',
        array( 'key' => 'opsh_client_id', 'type' => 'text', 'description' => __( 'Die Client-ID deiner OpenPanel-Anwendung.', 'kd-tracking-connector-openpanel' ) )
    );

    register_setting( 'opsh_settings_group', 'opsh_api_url', array( 'sanitize_callback' => 'esc_url_raw' ) );
    add_settings_field(
        'opsh_api_url',
        __( 'API-URL (Self-Hosted)', 'kd-tracking-connector-openpanel' ),
        'opsh_field_text',
        'kd-tracking-connector-openpanel',
        'opsh_section_general',
        array( 'key' => 'opsh_api_url', 'type' => 'url', 'description' => __( 'Nur bei Self-Hosting angeben, z.&nbsp;B. https://openpanel.example.com/api. Leer lassen für die offizielle Cloud.', 'kd-tracking-connector-openpanel' ) )
    );

    // --- Script delivery ---
    add_settings_section(
        'opsh_section_script',
        __( 'Script-Auslieferung', 'kd-tracking-connector-openpanel' ),
        '__return_false',
        'kd-tracking-connector-openpanel'
    );
    ...
    add_settings_field(
        'opsh_script_local',
        __( 'op1.js lokal ausliefern', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_script',
    ...
    add_settings_section(
        ...
        __( 'Tracking-Optionen', 'kd-tracking-connector-openpanel' ),
        '__return_false',
        'kd-tracking-connector-openpanel'
    );
    ...
    add_settings_field(
        ...
        __( 'Seitenaufrufe (trackScreenViews)', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_tracking',
    ...
    add_settings_field(
        ...
        __( 'Ausgehende Links (trackOutgoingLinks)', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_tracking',
    ...
    add_settings_field(
        ...
        __( 'HTML-Attribute (trackAttributes)', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_tracking',
    ...
    add_settings_section(
        'opsh_section_replay',
        __( 'Session Replay', 'kd-tracking-connector-openpanel' ),
        '__return_false',
        'kd-tracking-connector-openpanel'
    );
    ...
    add_settings_field(
        'opsh_session_replay',
        __( 'Session Replay aktivieren', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_replay',
    ...
    add_settings_field(
        ...
        __( 'Formularfelder maskieren (maskAllInputs)', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_replay',
    ...
    add_settings_section(
        ...
        __( 'Datenschutz &amp; Debug', 'kd-tracking-connector-openpanel' ),
        '__return_false',
        'kd-tracking-connector-openpanel'
    );
    ...
    add_settings_field(
        ...
        __( 'Eingeloggte Nutzer nicht tracken', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_privacy',
    ...
    add_settings_field(
        'opsh_respect_dnt',
        __( 'Do Not Track (DNT) respektieren', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_privacy',
    ...
    add_settings_field(
        'opsh_disable_debug',
        __( 'Bei WP_DEBUG deaktivieren', 'kd-tracking-connector-openpanel' ),
        'opsh_field_checkbox',
        'kd-tracking-connector-openpanel',
        'opsh_section_privacy',
...
function opsh_settings_page() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            do_settings_sections( 'kd-tracking-connector-openpanel' );
            submit_button( __( 'Änderungen speichern', 'kd-tracking-connector-openpanel' ) );
            ?>
        </form>
    </div>
    <?php
